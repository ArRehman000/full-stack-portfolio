...
const TECH_STACK = [
  "Next.js", "React", "Node.js", "MongoDB", "Web3", "LangChain"
];
    ...
    <section className="relative flex min-h-screen w-full flex-col justify-center px-6 md:px-14 py-20 overflow-hidden bg-[#0a0a0f]">
      ...
      <div className="relative z-10 max-w-6xl grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 items-center">
        <div>
          ...
          >
            Full Stack Developer &bull; 3 Years
          </motion.p>
          ...
          >
            Crafting scalable web applications from pixel-perfect UIs to robust backend systems. 
            Specializing in React, Next.js, Node.js and modern cloud infrastructure.
          </motion.p>
          ...
          >
            {STATS.map((stat) => (
              <div key={stat.label}>
                <div className="text-3xl font-medium text-zinc-100">{stat.value}</div>
                <div className="mt-1 text-[10px] uppercase tracking-wider text-zinc-500">{stat.label}</div>
              </div>
            ))}
          </motion.div>
